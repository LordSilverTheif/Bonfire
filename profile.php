...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <symbol id="bonfire" viewBox="0 0 448 512" >
        <title>Bonfire</title>
...
<main class="d-flex flex-nowrap">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            if($role == "student")
            {
                ?>
                <li class="nav-item">
                    <a href="#" class="nav-link text-white left-menu-item" aria-current="page">
                        <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"></use></svg>
                        All Courses
                    </a>
                </li>
    ...
    <div id="primary-window" class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark">
        <h1 class="my-5">Hi, <b><?php echo $firstName; ?></b>. Welcome to your profile.</h1>

        <form action="processor/editUserProcessor.php" method="post" >
            <label for="fname">First name:</label><br>
            <input class ="user-information" type="text" id="fname" name="fname" value="<?php echo $firstName ?>" disabled ><br>
            <label for="lname">Last name:</label><br>
            <input class ="user-information" type="text" id="lname" name="lname" value="<?php echo $lasName ?>" disabled ><br>
            <label for="email">Email:</label><br>
            <input class ="user-information" type="text" id="email" name="email" value="<?php echo $Email ?>"  disabled><br><br>
